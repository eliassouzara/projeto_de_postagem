...
?>
  ...
  <body>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Falta poucos passos para mudar de vida em poucos minutos :D</p>
    ...
    <form  method="POST" name="usuario" action="../Forms.php" enctype="/multipart/from-data"  >
                ...
                <label>Gênero:</label><span class="error">*</span>
     ...
     <br>
      ...
      <label for="cpfcnpj"  class="labelinput">CPF/CNPJ</label>
                    <input type="text" name="cpfcnpj" id="cpfcnpj" class="form-control" required>
      ...
      <div class="inp-wrapperd">
        ...
        <p>Tipos:</p>
                ...
                <input type="radio"  id="saldo" name="saldo" value="0,00" >
                <label for="0,00">por amigo</label>
                <br>
                <input type="radio"  id="saldo" name="saldo" value="0,00">
                <label for="0,00">por anucio</label>
                <br>
                <br>
                <div class="mb-3 form-password-toggle">
                  <label class="form-label" for="password">Cidade</label>
                  <div class="input-group input-group-merge">
                  <input type="text" name="cidade" placeholder="Sua cidade" class="form-control"  required>
