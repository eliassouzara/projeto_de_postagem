...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
  ...
  <div class="container-scroller">
      ...
      <!-- partial -->
      <div style=" padding-top: 48px; " class="container-fluid page-body-wrapper">
...
<i class="fa fa-lock" style="font-size:24px"></i>
  ...
  <div class="card-body">
  <img src="../img/mercadopago.png" style="width: 149px; margin-left: 15px;">
    <h5 class="card-title">COLOQUE O SEU e-mail DO <strong>MERCADO PAGO</strong></h5>
  
    <form  method="POST" name="pay" action="./consacar/mer.php"  >
    ...
    <div style=" 
         ...
         " class="inputBox">
                 ...
                 <label for="nomecompleto" class="labelinput"></label>
             </div>
             <br>
    ...
    <div style=" 
         ...
         letter-spacing: 2px;
         " class="inputBox">
                 <input type="text" name="seu_id" id="seu_id" placeholder="seu id" required>
                 <label for="seu_id" class="labelinput"></label>
             </div>
             <br>
             <div style=" 
         ...
         letter-spacing: 2px;
         " class="inputBox">
                 <input type="text" name="suaconta" id="suaconta" placeholder="sim/não" required>
                 <label for="suaconta	" class="labelinput"></label>
             </div>
             <br>
            <div style=" 
            ...
            letter-spacing: 2px;
            " class="inputBox">
                    <input type="text" name="emailmercadopago" id="emailmercadopago" placeholder="seu email" required>
                    <label for="emailmercadopago" class="labelinput"></label>
                </div>
                <br>

                <div style="outline: none;color: #343A40; letter-spacing: 2px;
            " class="inputBox">
                    <input type="number" name="valor" id="valor"  placeholder="R$0,00"  required>
                    <label for="valor" class="labelinput"  ></label>
