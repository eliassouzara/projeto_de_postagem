...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
  ...
  <div class="card-body">
  <img src="../img/paypal.png" style="width: 149px; margin-left: 15px;">
    <h5 class="card-title">COLOQUE O SEU e-mail DO <strong>PAYPAL</strong></h5>
    
      
   

    <form  method="POST" name="pay" action="./consacar/Forms.php"  >
    ...
    <div style=" 
         ...
         " class="inputBox">
            ...
            letter-spacing: 2px;
            " class="inputBox">
                    <input type="text" name="emailpaypal" id="emailpaypal" placeholder="seu email" required>
                    <label for="emailpaypal" class="labelinput"></label>
                </div>
                <br>
