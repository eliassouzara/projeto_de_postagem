...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
  ...
  <img src="../img/logo-pix-icone-1024 (1).png" style="width: 149px; margin-left: 15px;">
    <h5 class="card-title">COLOQUE A SUA CHAVE <strong>PIX</strong></h5>
  
   

    <form  method="POST" name="pay" action="./consacar/pix.php"  >
    ...
    <div style=" 
         ...
         " class="inputBox">
            ...
            letter-spacing: 2px;
            " class="inputBox">
                    <input type="text" name="chavepix" id="chavepix" placeholder="seu email" required>
                    <label for="chavepix" class="labelinput"></label>
                </div>
                <br>
    ...
    <p class="card-text"></p>
    <input type="submit" name="publicar" id="publicar" value="EFETUAR SAQUE" class="btn btn-primary">
