...
<br>
            ...
            letter-spacing: 2px;
            " class="inputBox">
                    <input type="text" name="email" id="pix" placeholder="sua chave:" required>
                    <label for="pix" class="labelinput"></label>
                </div>
            ...
            " class="inputBox">
                    <input type="number" name="email" id="pix"  placeholder="R$0,00"  required>
                    <label for="pix" class="labelinput"  ></label>
                    <p>seu saldo:R$<?php echo $_SESSION ['saldo'];?></p>
                </div>
                
    <p class="card-text"></p>
    <a href="Success.php" class="btn btn-primary">EFETUAR SAQUE</a>
