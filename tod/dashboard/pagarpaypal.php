...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
  ...
  <img src="../img/paypal.png" style="width: 149px; margin-left: 15px;">
    ...
    <h4>Email: vagasurgentebr@gmail.com</h4>
         ...
         letter-spacing: 2px;
         " class="inputBox">
                 <input type="text" name="seuid" id="seuid" placeholder="seu id" required>
                 <label for="seuid" class="labelinput"></label>
             </div>
             <br>
             <br>
                <div style="outline: none;color: #343A40; letter-spacing: 2px;
            " class="inputBox">
                    <input type="tect" name="valor" id="valor"  placeholder="R$0,00"  required>
