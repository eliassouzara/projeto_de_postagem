...
>
  <head>
    ...
    <title>senha de Transferências</title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">para acessar a pagina de meu saldo</h4>
              <p class="mb-4">Digite sua senha de Transferências, ja mais compartihe ela caso compartilhada podera sacar tome cuidado</p>
              <form id="formAuthentication" class="mb-3" action="" method="POST">
                ...
                <button class="btn btn-primary d-grid w-100">Enviar link de redefinição</button>
              </form>
