...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
  ...
  <div class="card-body">
  <img src="../img/mod.png" style="width: 149px; margin-left: 15px;">
    <h5 class="card-title">COLOQUE O ID <strong>funcionário/Freelancer</strong></h5>
  
   


<br>
<form  method="POST" name="pay" action="./contransicao/Forms.php"  >
            <div style=" 
            ...
            letter-spacing: 2px;
            " class="inputBox">
                    <input type="text" name="id_dequemvaireceber" id="id_dequemvaireceber" placeholder="ID:" required>
                    <label for="id" class="labelinput"></label>
                </div>
         ...
         letter-spacing: 2px;
         " class="inputBox">
                 <input type="text" name="nomedapessoa" id="nomedapessoa" placeholder="quem vai receber" required>
                 <label for="nomedapessoa" class="labelinput"></label>
             </div>
             <br>
                <div style=" 
         ...
         letter-spacing: 2px;
         " class="inputBox">
                 <input type="text" name="nomedaempresa" id="nomedaempresa" placeholder="Seu nome " required>
                 <label for="nomedaempresa" class="labelinput"></label>
             </div>
         ...
         letter-spacing: 2px;
         " class="inputBox">
                 <input type="text" name="meuid" id="meuid" placeholder="seu Id:" required>
                 <label for="id" class="labelinput"></label>
             </div>
