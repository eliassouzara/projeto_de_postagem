...
<html lang="en">
  <head>
    ...
    <title>perfil || Vagas urgentes</title>
    <!-- plugins:css -->
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
    ...
    <!--Stylesheet-->
    <link rel="stylesheet" href="styleey.css">
    <!-- inject:css -->
    <!-- endinject -->
    <!-- Layout styles -->
    ...
    <link rel="stylesheet" href="../../css/style.css">
    <!-- End layout styles -->
    <link rel="shortcut icon" href="../img/per.pngfavicoin.png" />
    ...
    font-weight: 600;"  class="menu-title">Master</span>
        ...
        <div class="main-panel">
              ...
              <div class="col-12 stretch-card grid-margin">
                <div style="margin-top:34px;" class="card card-secondary">
...
" class="card">
            <img style="
              ...
              border-radius: 50%;
              margin: 0 auto;
              box-shadow: 0 0 0 9px #ffff;
          " src="per.png" alt="profile_img">
            <h4><?php echo $_SESSION ['nome']; ?></h4>
            <h2><b>id:<b><?php echo $_SESSION ['id']; ?></h2>
            <div class="details">
                <div class="column">
                    <h2></h2>
                    <span></span>
        ...
        <div class="themes">
            <button style="background-color: #0063f5;" class="btn btn1"></button>
            <button style="background-color: #ff1756;" class="btn btn2"></button>
            <button style="background-color: #1cb65d;" class="btn btn3"></button>
            <button style="background-color: #8e44ad;" class="btn btn4"></button>
            <button  style="background-color: #f4b932;"class="btn btn5"></button>
        </div>
    </div>
