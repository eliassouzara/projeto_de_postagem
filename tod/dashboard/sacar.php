                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">SALDO ATUAL</h4>
                      ...
                      <h1 style="text-align: center;">SEU SALDO É:</h1>
                      <h1 style="font-size: 135px;
    text-align: center;">R$<?php echo $_SESSION ['saldo'];?></h1>

<h1>Opções de Pagamento:</h1>

<a href="addpaypal.php"><img src="../img/paypal.png" style="width: 149px; margin-left: 15px;"></a>
<a href="addpix.php"><img src="../img/logo-pix-icone-1024 (1).png"  style="width: 149px; margin-left: 210px;"></a>
<a href="addmercadopago.php"><img src="../img/mercadopago.png" style="width: 149px; margin-left: 250px;"></a>
