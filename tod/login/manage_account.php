...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `usuariosy` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
            ...
            <form id="account-form">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group m-0 p-0  col-sm-6">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-primary" type="button" id="pass">Generate</button>
                        </div>
                    </div>
                </div>
                <?php if(!isset($id)): ?>
...
<script>
    $(function(){
        $('#generate_pass').click(function(){
            var randomstring = Math.ceil(Math.random()*100000000)
            $('[name="account_number"]').val(randomstring)
        })
        $('#pass').click(function(){
