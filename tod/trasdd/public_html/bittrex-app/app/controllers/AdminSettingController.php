...
class Admin_SettingController extends BaseControllers
{
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function addNewCoinVote()
    {
        ...
        if (isset($check_coinvote->id)) {
            ...
            if (isset($wallet->id)) {
                ...
                return Redirect::to('admin/manage/coins-voting')->with('error', Lang::get('admin_messages.not_found_btc_wallet'));
            }
        }
    }
    ...
    public function editUSer($user_id = '')
    {
        ...
        if (!isset($user->id)) {
            return Redirect::to('admin/manage/users')->with('error', Lang::get('admin_messages.user_not_exist'));
        }
    ...
    public function banUSer()
    {
        ...
        if (isset($user->id)) {
            ...
            if ($status) {
                ...
                $message = Lang::get('admin_messages.remove_banned_success') . " " . $user->username . ".";
            }
            if (Input::get('isAjax')) {
                echo json_encode(array('status' => 'success', 'message' => $message));
                exit;
    ...
    public function editWallet($wallet_id = '')
    {
        ...
        if (!isset($wallet->id)) {
            return Redirect::to('admin/manage/wallets')->with('error', Lang::get('admin_messages.wallet_not_exist'));
        }
        $data['wallet'] = $wallet;
    ...
    public function addNewPost()
    {
        ...
        if (!empty($type) && !empty($title) && !empty($body)) {
            ...
            return Redirect::to('admin/content/add-' . $post->type)->with('error', Lang::get('admin_messages.fill_all_fields'));
        }
    }
    ...
    public function doEditPost()
    {
        ...
        if (!empty($type) && !empty($title) && !empty($body)) {
            ...
            return Redirect::to('admin/content/add-news')->with('error', Lang::get('admin_messages.fill_all_fields'));
        }
    }
    ...
    {
        if ($wallet_id == '') {
            return Redirect::to('admin/setting/time-limit-trade');
        }
    ...
    {
        if ($method_id == '') {
            return Redirect::to('admin/manage/method-deposit');
        }
        $MethodDepositCurrency = MethodDepositCurrency::find($method_id);
        if (!isset($MethodDepositCurrency->id)) {
            return Redirect::to('admin/manage/method-deposit')->with('error', Lang::get('admin_messages.method_deposit_not_exist'));
        }
        $data['MethodDepositCurrency'] = $MethodDepositCurrency;
    ...
    {
        if ($wallet_id == '') {
            return Redirect::to('admin/manage/method-withdraw');
        }
        $withdrawUSD = MethodWithdrawCurrency::find($wallet_id);
        if (!isset($withdrawUSD->id)) {
            return Redirect::to('admin/manage/withdraw-USD')->with('error', Lang::get('admin_messages.method_withdraw_not_exist'));
        }
