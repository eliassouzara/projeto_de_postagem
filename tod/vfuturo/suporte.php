        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">suporte ao usuário 🧑‍💻</h4>
              <p class="mb-4">fale um pouco do está acontecendo? estamos aqui para te ajudar!</p>

              <form id="formAuthentication" class="mb-3" method="POST" name="usuario" action="Forms.php">
                
                <div class="mb-3">
                  <label for="email" class="form-label">Email</label>
                  <input type="text" class="form-control" id="email" name="email" placeholder="coloque o seu Email" required />
                </div>
               
               
                <div class="mb-3">
                  <label for="email" class="form-label">qual e o problema?</label>
                  <input type="text" class="form-control" id="email" name="email" placeholder="Seja específico." required />
                </div>
                ...
                <button class="btn btn-primary d-grid w-100">Inscrever-se</button>
              </form>
